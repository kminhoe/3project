	...
	<div class="container">
		<div align="center" id="fit">
			<input type="radio" name="findId" onClick="location.href='findId.da'"
				checked="checked"> 이메일로 찾기 <input type="radio" name="findId"
				onClick="location.href='findIdPhone.da'"> 전화번호로 찾기
		</div>
		<br>
		<div id="fid">
			<form id="fip" action="findIdResult.da" method="POST">
				<div>
				...
				<br>
				<div>
					<label>E-mail : </label> <span><input type="text"
						class="register_text" maxlength="40" name="user_email"
						id="user_email" placeholder="이메일 입력"></span>
				</div>
				<br>
