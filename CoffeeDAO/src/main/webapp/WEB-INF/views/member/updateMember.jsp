  ...
  cursor: pointer;
   ...
   <body>
      ...
      <div class="product_section layout_padding">
        <div align="center">
            <div class="col-md-12">
               <h1 class="login_taital">회원정보 수정</h1>
            </div>
            <div class="container">
                <div>
                    ...
                    <div align="center">
                        ...
                        <form id="update" name="update" method="POST" action="update.da">
                            <br>
                            <br>
                            ...
                            <br><br>
                            이름<br>
                            <input class="register_text" id="MEM_NAME" name="MEM_NAME" value="${map.MEM_NAME}" type="text"><br><br>
                            이메일<br>
                            <input class="register_text" id="MEM_EMAIL" name="MEM_EMAIL" value="${map.MEM_EMAIL}" type="text"><br><br>
                            전화번호<br>
                            <input class="register_text" id="MEM_PHONE" name="MEM_PHONE" value="${map.MEM_PHONE}" type="text"><br><br>
                            주소<br>
                            <input style="width:37%"class="register_zp" id="MEM_ZP" name="MEM_ZP" value="${map.MEM_ZP}" type="text">&nbsp;&nbsp;<input type="button" class="register_button2" onclick="sample6_execDaumPostcode()" value="우편번호"/><br><br>
                            <input class="register_text" id="MEM_ADDR1" name="MEM_ADDR1" value="${map.MEM_ADDR1}" type="text"><br><br>
                            상세주소<br>
                            <input class="register_text" id="MEM_ADDR2" name="MEM_ADDR2" value="${map.MEM_ADDR2}" type="text"><br><br>
                            <div class="register_subcenter">
                                <button  class="register_button" id ="update" onclick="check(this.form)">저장</button>
                                <br>
                            </div>
                        </form>    
                    </div>
...
function fn_updateMember(){
	location.href='/coffeedao/update.da'
}
