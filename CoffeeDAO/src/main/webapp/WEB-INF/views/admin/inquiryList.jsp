...
<form id="Search" name="Search" method="post" action="/coffeedao/adminInquiryList.da">
...
<div>
<c:forEach items="${inquiryList}" var="member">
	<button class="collapsible_admin">${member.QA_TITLE}</button>
  			...
  			<table id="customers">
  				...
  				<tbody>
  					<tr>
  						...
  						<td colspan="4">${member.QA_DATE}</td>
  						<td>${member.QA_WRITER}</td>
  						<td>${member.QA_STATE}</td>
  						<td align="center">
  							<a href="adminInquiryReply.da?QA_IDX=${member.QA_IDX}">답변쓰기</a>&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;<a href="adminInquiryDelete.da?QA_IDX=${member.QA_IDX}">삭제</a>
  						</td>
  					</tr>
  				</tbody>
  			</table>
