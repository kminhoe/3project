	...
	<div class="product_section layout_padding">
		<div class="row">
			<div align="center" class="col-md-12">
				<h1 class="login_taital">답변 수정</h1>
			</div>
			<div class="container">
				<div class="register_center"></div>
				<form id="wit" action="productAnswerUpdatePro.da" method="post">
					<h5 style="font-size: 15px;">[상품코드 ${map.RE_ITEM}]</h5>
					<table
						style="border-bottom: 1px solid; margin: 0px 0px 0px 0px; width: 100%;">
						<thead>
							<tr>
					...
					<table style="margin: 0px 0px 0px 0px; width: 100%;">
						<tr>
							<th style="width: 90px;">답글 수정</th>
							<td><textarea rows="6" cols="50" style="resize: none;"
									maxlength="200" name="RE_CONTENT" id="RE_CONTENT">${maps.RE_CONTENT}</textarea></td>
						</tr>
					</table>
					<input type="hidden" name="RE_ITEM" value="${map.RE_ITEM}"><input
						type="hidden" name="ITEM_ID" value="${map.RE_ITEM}"> <input
						type="hidden" name="RE_REF" value="${map.RE_REF}">
				</form>
				<br>
				<div>
